...
$get_sup_no = select_query("SELECT support_number FROM $employee_track.login_details_new WHERE id='".$_SESSION['user_id']."' ");
...
if (isset($_POST['save_people'])) {
	...
	$call_support_no = $_POST['call_support_no'];
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <form name="myForm" id="myForm" action="" method="post" class="form-horizontal" autocomplete="off" >
                ...
                <div class="controls"> 
                    <div class="col-sm-3">
                        ...
                        <?php for($rq=0;$rq<count($get_emp_recd);$rq++) { ?>
                          <option value="<?=$get_emp_recd[$rq]['emp_details'].'##'.$get_emp_recd[$rq]['day_start_end'];?>"><?=$get_emp_recd[$rq]['emp_name'];?></option>
              ...
              <div class="control-group">
                <label class="control-label">Call Support No:</label>
                <div class="controls">
                  <input type="text" name="call_support_no" maxlength="10" id="call_support_no"  value="<?=$get_sup_no[0]['support_number']?>" class="mandatory" readonly="readonly" />
                  <span id="branch_error"></span> </div>
              </div>
