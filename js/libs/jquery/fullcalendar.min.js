...
(function(t, e) {
    ...
    function ce() {
        ...
        function l(t, e) {
			//alert(t.class_status);
			if(t.class_status=='done'){
				
				var statuscss= "fc-event fc-event-done ";
				
			}
			else if( t.class_status=='canceled'){
				var statuscss= "fc-event fc-event-cancel";
				
			}
			else{
				
				var statuscss= "fc-event";
			}
            var n = "<",
                r = t.url,
                a = Q(t, y),
                o = [ statuscss, "fc-event-vert"];
    ...
    function fe() {
        ...
        function a(t) {
			//console.log(t);
            var statuscss,e, n, r, a, o, i, s, c, l, u, f = y("isRTL"),
                d = t.length,
                v = F(),
                h = v.left,
                g = v.right,
            ...
            for (e = 0; d > e; e++)
				...
				n = t[e], 
				r = n.event,
				statuscss= (r.class_status=='done') ? "fc-event fc-event-done ": ((r.class_status=='canceled')?"fc-event fc-event-cancel":"fc-event"),	
				o = [statuscss, "fc-event-hori"],w(r) && o.push("fc-event-draggable"),n.isStart && o.push("fc-event-start"),
				n.isEnd && o.push("fc-event-end"),f ? (i = A(n.end.getDay() - 1),
				s = A(n.start.getDay()), 
				c = n.isEnd ? N(i) : h, 
				l = n.isStart ? W(s) : g) : (i = A(n.start.getDay()),
				s = A(n.end.getDay() - 1), 
				c = n.isStart ? N(i) : h,
				l = n.isEnd ? W(s) : g),
				o = o.concat(r.className), r.source && (o = o.concat(r.source.className || [])),
				a = r.url,
				u = Q(r, y), 
				p += a ? "<a href='" + V(a) + "'" : "<div", 
				p += " class='" + o.join(" ") + "'" + " style='position:absolute;z-index:8;left:" + c + "px;" + u + "'" + ">" + "<div class='fc-event-inner'>", !r.allDay && n.isStart && (p += "<span class='fc-event-time'>" + V(I(r.start, r.end, y("timeFormat"))) + "</span>"), p += "<span class='fc-event-title'>" + V(r.title) + "</span>" + "</div>", n.isEnd && D(r) && (p += "<div class='ui-resizable-handle ui-resizable-" + (f ? "w" : "e") + "'>" + "&nbsp;&nbsp;&nbsp;" + "</div>"),
