...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="view_technicians.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="current">All Technicians Notification</a> </div>
            ...
            <table class="table table-bordered data-table table-responsive-lg" id="filtertable">
              ...
              <tbody>
			  	<?php for($emp=0;$emp<count($get_tech_leave_data);$emp++) { 
					...
					{
						$get_tech_data = select_query("SELECT * FROM $db_name.technicians_login_details WHERE id='".$get_tech_leave_data[$emp]['person_id']."' ");
						$tech_name = $get_tech_data[0]['emp_name'];
					} else {
						$tech_name = $get_tech_leave_data[$emp]['person_id'];
					}
				?>
                <tr class="gradeX">
