...
<div id="user-nav" class="navbar navbar-inverse">
  <ul class="nav">
    <!--<li  class="dropdown" id="profile-messages" ><a title="" href="#" data-toggle="dropdown" data-target="#profile-messages" class="dropdown-toggle"><i class="icon icon-user"></i>  <span class="text">Welcome User</span><b class="caret"></b></a>
	 ...
	 <li class="dropdown" id="menu-messages"><a href="#" data-toggle="dropdown" data-target="#menu-messages" class="dropdown-toggle"><i class="icon icon-envelope"></i> <span class="text">Manage Contacts</span> <span class="label label-important"><?php echo mysql_num_rows($count_contacts);?></span> <b class="caret"></b></a>
      <ul class="dropdown-menu">
        ...
        <li class="divider"></li>
        <li><a class="sInbox" title="" href="view-contacts.php"><i class="icon-search"></i> View All Contacts</a></li>
	...
	<li class="dropdown" id="menu-main"><a href="#" data-toggle="dropdown" data-target="#menu-main" class="dropdown-toggle"> <span class="text">Manage Category</span> <b class="caret"></b></a>
      <ul class="dropdown-menu">

        <li><a class="sAdd" title="" href="view-branch.php"> Manage Branch </a></li>
        <li class="divider"></li>

        <li><a class="sInbox" title="" href="view-level.php"> Manage Level</a></li>
        <li class="divider"></li>

        <li><a class="sInbox" title="" href="view-people.php"> Manage People</a></li>
        <li class="divider"></li>

        <li><a class="sAdd" title="" href="view-vehicle-category.php"> Manage Vehicle Category</a></li>
        <li class="divider"></li>

        <li><a class="sAdd" title="" href="view-vehicle-type.php"> Manage Vehicle Type </a></li>
        <li class="divider"></li>

        <li><a class="sAdd" title="" href="view-vehicle-make.php"> Manage Vehicle Make </a></li>
        <li class="divider"></li>

        <li><a class="sAdd" title="" href="view-category.php">Manage Vehicle </a></li>
        <li class="divider"></li>
        ...
        <li><a class="sInbox" title="" href="view-business-type.php">Manage Business Type</a></li>
        <li class="divider"></li>
		
		
		 <li><a class="sAdd" title="" href="view-material-type.php"> Manage Material Type </a></li>
        <li class="divider"></li>
        
		
		

        <li><a class="sInbox" title="" href="view-party.php"> Manage Party</a></li>
        <li class="divider"></li>
		
		<li><a class="sAdd" title="" href="view-third-party.php"> Manage Third Party </a></li>
        <li class="divider"></li>
        <li><a class="sInbox" title="" href="view-route.php"> Manage Route</a></li>
   ...
   <!--<li class="dropdown open" id="menu-cat"><a href="#" data-toggle="dropdown" data-target="#menu-cat" class="dropdown-toggle"><span class="text">Manage Category</span> <b class="caret"></b></a>
        ...
        <li class="divider"></li>
        <li><a class="sInbox" title="" href="view-category.php"><i class="icon-search"></i> View All Categories</a></li>
   ...
   <!-------------------------------------Muli submenu--------------------->  
    ...
    <li class="dropdown" id="menu-trip"><a href="#" data-toggle="dropdown" data-target="#menu-trip" class="dropdown-toggle"><i class=""></i> <span class="text">Manage Exception</span> <!-- <span class="label label-important"></span> --> <b class="caret"></b></a>
      <ul class="dropdown-menu">

        <li><a class="sInbox" title="" href="view-exception-type.php">Manage Exception Type</a></li>
        <li class="divider"></li>

        <li><a title="" href="show_accept.php"><!-- <i class="icon-arrow-up"></i> --> <span class="text">Accepted PopUp</span></a></li>

        
        <li class="divider"></li>

        <li><a title="" href="edit_addtolist.php"><!-- <i class="icon-arrow-up"></i> --> <span class="text">Add to List PopUp</span></a></li>

      <!--   <li class="divider"></li> -->
        <!-- <li><a class="sInbox" title="" href="view-trip.php"><i class="icon-search"></i> View Trip</a></li> -->
