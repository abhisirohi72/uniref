...
{			
	$WhereQuery="WHERE loginid='".$_SESSION['user_id']."' and to_technician!='' and job_status!=5 and is_active='1' and request_date<='".$currentdate."' ";
}
   
$get_job_data = select_query("SELECT * FROM $db_name.all_job_details ". $WhereQuery." order by id desc ");

/*$get_job_data = select_query("SELECT * FROM $employee_track.login_emp_details WHERE loginid='".$_SESSION['user_id']."' and is_active='1' order by created_date desc ");*/
